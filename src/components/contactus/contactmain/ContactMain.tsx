...
function ContactMain() {
  return (
    <>
      ...
      <section className="bg-[#fffbf7] py-8 px-4">
        <div className="max-w-6xl mx-auto grid gap-6 sm:grid-cols-1 md:grid-cols-12">
          {/* Address Card */}
          <div className="bg-[#e7d1d1] rounded-lg p-6 flex flex-col items-center text-center shadow-md md:col-span-6 sm:col-span-1">
          ...
          {/* Phone Card */}
          <div className="bg-[#e2dcad] rounded-lg p-6 flex flex-col items-center text-center shadow-md md:col-span-3 sm:col-span-1">
          ...
          {/* Email Card */}
          <div className="bg-[#d4cdf2] rounded-lg p-6 flex flex-col items-center text-center shadow-md md:col-span-3 sm:col-span-1">
