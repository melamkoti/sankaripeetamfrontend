    ...
    return (
      <div key={index} className="relative flex items-center ">
        ...
        >
          ...
          {item.childNav && (
            <div
              className={`absolute top-full left-0 mt-2 z-20 shadow-lg shadow-[#54321c] bg-[#5d3608] text-white font-normal text-sm p-4 rounded-md min-w-[200px] transition-all duration-200  ${
                isActive 
