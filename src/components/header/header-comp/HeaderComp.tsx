...
export default function Navbar() {
  return (
    <div className="w-screen relative flex justify-center items-center">
      <nav className="shadow-xl backdrop-blur-md bg-[#49263d] bg-opacity-70 fixed top-0 left-0 text-white w-[100%] text-sm p-0 m-0 flex justify-between items-center py-5 md:px-2 md:pr-8">
        <NavLink to="/">
