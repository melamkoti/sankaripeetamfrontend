...
//   return (
//     <div className="w-[1440px] z-50">
//       {/* Top Section */}
//       <div className="lg:hidden  flex gap-4 items-center px-4  py-3 bg-[#FDAE51]">
//         <NavLink to="/" className="flex items-center justify-center">
//           <img src={LogoImg} className="w-[44px] h-[44px]" alt="Website Logo" />
//         </NavLink>
//         <div className="text-left ">
//           <h2 style={{fontFamily:"Oswald"}}  className="text-[15px] font-normal font-oswald ">
...
//       <div className="hidden bg-[#FDAE51] lg:flex  justify-between  items-center px-4 md:px-16 py-3 h-[146px]">
//         {/* Left Title */}
//         <div className="text-left flex flex-col gap-[2px] mt-[-8px]">
//           <h2 style={{fontFamily:"Oswald"}} className="text-lg font-medium md:text-[30px] mb-[3px]  font-oswald 
// ">
//             Sanathana Sankari Peetam
//           </h2>
...
//       <div className="hidden bg-[#8e512c] lg:flex justify-between items-center px-4 md:px-16 py-2 shadow ">
//         <div className="hidden md:flex lg:w-[300px] "></div>
    ...
    <div className="fixed top-0 left-0 right-0 z-50 ">
      ...
      <div className="mx-auto max-w-[1440px] relative">
        ...
        <div className="hidden lg:block">
          {/* Top Title Section */}
          <div className="bg-[#FDAE51] flex justify-between items-center px-4 md:px-16 py-3 h-[146px]">
            {/* Left Title */}
            <div className="text-left flex flex-col gap-[2px] mt-[-8px]">
              <h2 style={{fontFamily:"Oswald"}} className="text-lg font-medium md:text-[30px] mb-[3px] font-oswald">
                Sanathana Sankari Peetam
          ...
          <div className="bg-[#8e512c] flex justify-between items-center px-4 md:px-16 py-2 shadow">
            {/* <div className="none md:flex lg:w-[100px]"></div> */}
