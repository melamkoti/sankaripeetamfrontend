...
export default function UpComingEventsCard({
  ...
  return (
    <div
      className="w-full max-w-8xl flex flex-col gap-6"
    ...
    >
      ...
      >
        ...
        {/* Content */}
        <div className="p-6 flex flex-col justify-between md:w-2/3 relative">
          <div>
            ...
            <p
              className={` ${
                ...
                } text-sm md:text-base mt-2 leading-snug text-[18px] font-normal max-h-40 overflow-y-auto`}
            >
              {item.description}
            </p>
          </div>
