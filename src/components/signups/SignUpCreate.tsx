...
function SignUpCreate() {
  ...
  return (
    <div className=" h-screen main_head">
      ...
      >
        <div className="lex flex-col  lg:w-2/6 w-4/6 md:w-3/6 justify-center items-center bg-white opacity-90 gap-6 p-8 z-10 md:mr-32 m-6 rounded-xl">
          ...
          <p className=" text-center md:mt-4 mt-2 text-sm md:text-xl">
