...
const UserProfile: React.FC = () => {
  ...
  return (
    <div
      className="
        max-w-md w-full 
        md:rounded-2xl md:shadow-lg md:border md:border-amber-100 md:overflow-hidden 
        md:bg-gradient-to-br md:from-amber-50 md:to-orange-50
        fixed md:relative top-0 left-0 h-screen md:h-auto w-screen md:w-full 
        bg-gradient-to-br from-amber-50 to-orange-50 z-50
        p-6 md:p-8
      "
    >
      {user ? (
        <div className=" z-10 flex flex-col items-center h-full overflow-y-auto">
          {/* Avatar */}
